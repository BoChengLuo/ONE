...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        //    标题
        _heading = [[UILabel alloc]initWithFrame:CGRectMake(5, 5, 0, 0)];
        ...
        //    作者
        _auther = [[UILabel alloc]initWithFrame:CGRectMake(5, 10 + rect.size.height, 0, 15)];
        _auther.font = [UIFont systemFontOfSize:13];
        [self.contentView addSubview:_auther];
        //    内容
        _textlabel = [[UILabel alloc]initWithFrame:CGRectMake(5, 30 + rect.size.height, 0, 0)];
